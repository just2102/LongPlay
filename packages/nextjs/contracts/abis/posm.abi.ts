export const posmAbi = [
  {
    inputs: [
      ...
      { internalType: "contract IAllowanceTransfer", name: "_permit2", type: "address" },
      { internalType: "uint256", name: "_unsubscribeGasLimit", type: "uint256" },
      { internalType: "contract IPositionDescriptor", name: "_tokenDescriptor", type: "address" },
  ...
  },
  {
    inputs: [{ internalType: "uint256", name: "tokenId", type: "uint256" }],
    name: "subscriber",
    outputs: [{ internalType: "contract ISubscriber", name: "subscriber", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract IPositionDescriptor", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
